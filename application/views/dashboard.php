    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(<?php echo base_url() ?>themes/OnePage/assets/img/intro-carousel/1.jpg)">
          ...
          <div class="carousel-item" style="background-image: url(<?php echo base_url() ?>themes/OnePage/assets/img/intro-carousel/2.jpg)">
            <div class="carousel-container">
              <div class="container">
          ...
          <div class="carousel-item" style="background-image: url(<?php echo base_url() ?>themes/OnePage/assets/img/intro-carousel/3.jpg)">
            <div class="carousel-container">
              <div class="container">
          ...
          <div class="carousel-item" style="background-image: url(<?php echo base_url() ?>themes/OnePage/assets/img/intro-carousel/4.jpg)">
            <div class="carousel-container">
              <div class="container">
          ...
          <div class="carousel-item" style="background-image: url(<?php echo base_url() ?>themes/OnePage/assets/img/intro-carousel/5.jpg)">
            <div class="carousel-container">
              <div class="container">
  ...
  <main id="main">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 box">
            ...
            <h4 class="title"><a href="">Informasi Publik Berkala</a></h4>
            <p class="description">Merupakan informasi yang wajib disediakan dan diumumkan secara berkala</p>
          </div>

          <div class="col-lg-4 box box-bg">
            <i class="ion-ios-information-outline"></i>
            <h4 class="title"><a href="">Informasi Publik Serta Merta</a></h4>
            <p class="description">Informasi yang dapat mengancam hajat hidup orang banyak dan ketertiban umum</p>
          </div>

          <div class="col-lg-4 box">
            <i class="ion-ios-information-outline"></i>
            <h4 class="title"><a href="">Informasi Publik Setiap Saat</a></h4>
            <p class="description">Informasi yang wajib disediakan oleh Badan Publik</p>
          </div>
    ...
    <section id="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="facts-img">
          <img src="<?php echo base_url() ?>themes/OnePage/assets/img/facts-img.png" alt="" class="img-fluid">
        </div>
    ...
    <section id="portfolio" class="section-bg">
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/web3.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/web3.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Web 3"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/app2.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/app2.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="App 2"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/card2.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/card2.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Card 2"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/web2.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/web2.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Web 2"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/app3.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/app3.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="App 3"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/card1.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/card1.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Card 1"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/card3.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/card3.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Card 3"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <figure>
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/web1.jpg" class="img-fluid" alt="">
              <a href="<?php echo base_url() ?>themes/OnePage/assets/img/portfolio/web1.jpg" class="link-preview venobox" data-gall="portfolioGallery" title="Web 1"><i class="ion ion-eye"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
            </figure>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/team-1.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/team-2.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/team-3.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <img src="<?php echo base_url() ?>themes/OnePage/assets/img/team-4.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Amanda Jepson</h4>
